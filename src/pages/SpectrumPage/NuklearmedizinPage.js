...
import { messages } from './NuklearmedizinPage.i18n';
...
const NuklearmedizinPageHero = (props) =>
(
...
NuklearmedizinPageHero.propTypes = {
  backgroundImage: PropTypes.string.isRequired,
};

class NuklearmedizinPage extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <section id="spectrum-mammographie-page">
        <NuklearmedizinPageHero backgroundImage="/images/bg00.jpg" />
      </section>
    );
  }
}

export default connect(() => ({}))(NuklearmedizinPage);
