...
import { messages } from './MammographiePage.i18n';
...
const MammographiePageHero = (props) =>
(
...
MammographiePageHero.propTypes = {
  backgroundImage: PropTypes.string.isRequired,
};

class MammographiePage extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <section id="spectrum-mammographie-page">
        <MammographiePageHero backgroundImage="/images/bg00.jpg" />
      </section>
    );
  }
}

export default connect(() => ({}))(MammographiePage);
