...
import { messages } from './HerzMRTPage.i18n';
...
HerzMRTPageHero.propTypes = {
  backgroundImage: PropTypes.string.isRequired,
};

class HerzMRTPage extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <section id="spectrum-mrt-page">
        <HerzMRTPageHero backgroundImage="/images/bg00.jpg" />
      </section>
    );
  }
}

export default connect(() => ({}))(HerzMRTPage);
