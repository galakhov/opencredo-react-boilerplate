    ...
    <Grid style={styles_custom.team_container}>
      <Row>
        ...
        <div className="text-team" style={styles_custom.team_container_caption}>
          ...
          <p>
            <FormattedHTMLMessage {...messages.overview0} />
            <br /><FormattedHTMLMessage {...messages.overview01} />
            <br /><span style={styles_custom.span_color}><FormattedHTMLMessage {...messages.overview02} /></span>
          </p>
